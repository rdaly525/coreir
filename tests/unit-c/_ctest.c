...
int main() {
  ...
  COREModule* m = CORENewModule(
    ns,
    "Main",
    CORERecord(c, CORENewMap(c, NULL, NULL, 0, STR2TYPE_ORDEREDMAP)),
    NULL);
  ...
  COREWireable* inst = COREModuleDefAddModuleInstance(
    mdef, "ctop", lut4, config);
  (void)inst;
