...
void addCounter(Context* c, Namespace* global) {
  ...
  Generator* counter = global->newGeneratorDecl(
    "myCounter", counterTypeGen, counterParams);
...
TEST_CASE("Unified buffer simulation stub") {
  ...
  auto ubufstubTg = g->newTypeGen(
    "ubufstub_type", params, [](Context* c, Values genargs) {
...
class UnifiedBufferAddressGenerator : public SimulatorPlugin {
 ...
 public:
  ...
  UnifiedBufferAddressGenerator(
    vector<int> range, vector<int> stride, vector<int> start, int myWidth)
    : is_done(false) {
  ...
  void initialize(vdisc vd, SimulatorState& simState) {
    ...
    init_parameters(
      myWidth, get_dims(rangeType), get_dims(strideType), get_dims(startType));
  }
  ...
  void exeCombinational(vdisc vd, SimulatorState& simState) {
    ...
    simState.setValue(
      toSelect(inst->sel("out")), BitVector(width, addr_offset));
  }
};
...
TEST_CASE("Unified buffer address generator simulation") {
  ...
  auto uBufAddrTg = g->newTypeGen(
    "ubufaddrgen_type", params, [](Context* c, Values genargs) {
      uint width = genargs.at("width")->get<int>();
  ...
  Module* wrapperMod = c->getGlobal()->newModuleDecl(
    "bufaddrWrapper", bufaddrWrapperType);
  ModuleDef* def = wrapperMod->newModuleDef();
...
TEST_CASE("Interpret simulator graphs") {
  ...
  SECTION("And 4") {
    ...
    Wireable* and_00 = def->addInstance(
      "and00", and2, {{"width", Const::make(c, n)}});
    Wireable* and_01 = def->addInstance(
      "and01", and2, {{"width", Const::make(c, n)}});
    Wireable* and_1 = def->addInstance(
      "and1", and2, {{"width", Const::make(c, n)}});
  ...
  SECTION("Or 4") {
    ...
    Wireable* or_00 = def->addInstance(
      "or00", or2, {{"width", Const::make(c, n)}});
    Wireable* or_01 = def->addInstance(
      "or01", or2, {{"width", Const::make(c, n)}});
    Wireable* or_1 = def->addInstance(
      "or1", or2, {{"width", Const::make(c, n)}});
  ...
  SECTION("Counter") {
    ...
    def->addInstance(
      "counter", "global.myCounter", {{"width", Const::make(c, pcWidth)}});
  ...
  SECTION("Test bit vector addition") {
    ...
    Wireable* self = def->sel("self");
    Wireable* or_00 = def->addInstance(
      "or00", add2, {{"width", Const::make(c, n)}});
  ...
  SECTION("Multiplexer") {
    ...
    Wireable* mux = def->addInstance(
      "m0", "coreir.mux", {{"width", Const::make(c, width)}});
  ...
  */
  ...
  SECTION("D flip flop") {
    ...
    Wireable* dff0 = def->addInstance(
      "dff0", dff, {{"init", Const::make(c, true)}});
