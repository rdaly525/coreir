...
void colorAdd4Tree(NGraph& g) {
  for (auto& vd : g.getVerts()) {
    ...
    if (isSelect(w)) {
      ...
      if (ss == "in0" || ss == "in1") { wd.setThreadNo(0); }
      ...
      if (w->toString() == "add00") { wd.setThreadNo(0); }
...
TEST_CASE("Combinational logic simulation") {
  ...
  SECTION("16 bit add with carry out only") {
    ...
    // Define Add4 Module
    Type* add4Type = c->Record({{"in", c->Array(2, c->Array(n, c->BitIn()))},
                                {"out", c->Array(n, c->Bit())},
                                {"cout", c->Bit()}});
    ...
    Wireable* add0 = def->addInstance(
      "add0",
      add2,
      {{"width", Const::make(c, n)},
       {"has_cin", Const::make(c, false)},
       {"has_cout", Const::make(c, true)}});
  ...
  SECTION("32 bit add 4") {
    ...
    // Define Add4 Module
    Type* add4Type = c->Record({{"in0", c->Array(n, c->BitIn())},
    ...
    SECTION("Checking graph size") { REQUIRE(numVertices(gr) == 8); }
    ...
    //     cout << "Node " << vd << " has thread number = " << wd.getThreadNo()
    //     << endl;
    //   }
  ...
  SECTION("6 bit signed remainder 3 operations") {
    ...
    // Define Srem4 Module
    Type* srem4Type = c->Record({{"in", c->Array(3, c->Array(n, c->BitIn()))},
                                 {"out", c->Array(n, c->Bit())}});

    Module* srem4_n = g->newModuleDecl("Srem4", srem4Type);
    ModuleDef* def = srem4_n->newModuleDef();
    Wireable* self = def->sel("self");
    Wireable* srem_00 = def->addInstance(
      "srem00", srem2, {{"width", Const::make(c, n)}});
    Wireable* srem_01 = def->addInstance(
      "srem01", srem2, {{"width", Const::make(c, n)}});
    Wireable* srem_1 = def->addInstance(
      "srem1", srem2, {{"width", Const::make(c, n)}});
    ...
    int s = compileCodeAndRun(
      topoOrder, gr, srem4_n, "./gencode/", "srem4", "test_srem4.cpp");
  ...
  SECTION("64 bit subtract") {
    ...
    Type* sub4Type = c->Record({{"in", c->Array(4, c->Array(n, c->BitIn()))},
                                {"out", c->Array(n, c->Bit())}});

    Module* sub4_n = g->newModuleDecl("Sub4", sub4Type);
    ModuleDef* def = sub4_n->newModuleDef();
    Wireable* self = def->sel("self");
    Wireable* sub_00 = def->addInstance(
      "sub00", sub2, {{"width", Const::make(c, n)}});
    Wireable* sub_01 = def->addInstance(
      "sub01", sub2, {{"width", Const::make(c, n)}});
    Wireable* sub_1 = def->addInstance(
      "sub1", sub2, {{"width", Const::make(c, n)}});
    ...
    SECTION("Checking graph size") { REQUIRE(numVertices(g) == 5); }
  ...
  SECTION("Multiply 8 bits") {
    ...
    Type* mul2Type = c->Record({{"in", c->Array(2, c->Array(n, c->BitIn()))},
                                {"out", c->Array(n, c->Bit())}});
    ...
    Wireable* self = def->sel("self");
    Wireable* mul = def->addInstance(
      "mul1", mul2, {{"width", Const::make(c, n)}});
    ...
    SECTION("Checking graph size") { REQUIRE(numVertices(g) == 3); }
  ...
  SECTION("And then add, mask removal test") {
    ...
    Type* cType = c->Record({{"a", c->Array(n, c->BitIn())},
                             {"b", c->Array(n, c->BitIn())},
                             {"c", c->Array(n, c->BitIn())},
                             {"out", c->Array(n, c->Bit())}});
    ...
    Wireable* self = def->sel("self");
    Wireable* and0 = def->addInstance(
      "and0", andG, {{"width", Const::make(c, n)}});
    Wireable* add0 = def->addInstance(
      "add0", addG, {{"width", Const::make(c, n)}});
  ...
  SECTION("One 37 bit and") {
    ...
    Type* andType = c->Record({{"input", c->Array(2, c->Array(n, c->BitIn()))},
    ...
    SECTION("Compiling code") {
      ...
      int s = compileCodeAndRun(
        topoOrder, g, andM, "./gencode/", "and37", "test_and37.cpp");
  ...
  SECTION("One 63 bit addition") {
    ...
    Type* addType = c->Record({{"input", c->Array(2, c->Array(n, c->BitIn()))},
                               {"output", c->Array(n, c->Bit())}});
    ...
    int s = compileCodeAndRun(
      topoOrder, g, addM, "./gencode/", outFile, "test_add63.cpp");
  ...
  SECTION("One 2 bit not") {
    ...
    Type* neg2Type = c->Record(
      {{"A", c->Array(n, c->BitIn())}, {"res", c->Array(n, c->Bit())}});
    ...
    Wireable* self = def->sel("self");
    Wireable* neg0 = def->addInstance(
      "neg0", neg, {{"width", Const::make(c, n)}});
    ...
    SECTION("Compiling code") {
      ...
      string outFile = "neg2";
      int s = compileCodeAndRun(
        topoOrder, gr, neg_n, "./gencode/", outFile, "test_neg2.cpp");
  ...
  SECTION("Two 16 bit nots") {
    ...
    Wireable* neg0 = def->addInstance(
      "neg0", neg, {{"width", Const::make(c, n)}});
    Wireable* neg1 = def->addInstance(
      "neg1", neg, {{"width", Const::make(c, n)}});
    ...
    SECTION("Checking graph size") { REQUIRE(numVertices(g) == 6); }
    ...
    SECTION("Printing multithreaded code") {
      ...
      int s = compileCode(
        topoOrder, g, neg_n, "./gencode/", "two_negs_parallel");
      REQUIRE(s == 0);
    }
  }
  ...
  SECTION("Add 2 by 3 64 bit matrices") {
    ...
    for (int i = 0; i < 2; i++) {
      for (int j = 0; j < 3; j++) {
        ...
        Wireable* addInst = def->addInstance(
          str, add, {{"width", Const::make(c, n)}});
    ...
    int s = compileCodeAndRun(
      topoOrder, g, addM, "./gencode/", "mat2_3_add", "test_mat2_3_add.cpp");
  ...
  SECTION("Equality comparison on 54 bits") {
    ...
    Type* eqType = c->Record(
      {{"A", c->Array(2, c->Array(n, c->BitIn()))}, {"out", c->Bit()}});
  ...
  SECTION("sle on 7 bits") {
    ...
    Wireable* self = def->sel("self");
    Wireable* sle0 = def->addInstance(
      "sle0", sle, {{"width", Const::make(c, n)}});
    ...
    int s = compileCodeAndRun(
      topoOrder, g, sleM, "./gencode/", "sle7", "test_sle7.cpp");
    REQUIRE(s == 0);
  }
  ...
  SECTION("gt on 16 bits") {
    ...
    Wireable* self = def->sel("self");
    Wireable* ugt0 = def->addInstance(
      "ugt0", ugt, {{"width", Const::make(c, n)}});
    ...
    int s = compileCodeAndRun(
      topoOrder, g, ugtM, "./gencode/", "ugt16", "test_ugt16.cpp");
    REQUIRE(s == 0);
  }
  ...
  SECTION("Multiplexer test") {
    ...
    Type* muxType = c->Record({{"A", c->Array(2, c->Array(n, c->BitIn()))},
                               {"sel", c->BitIn()},
                               {"out", c->Array(n, c->Bit())}});
    ...
    Wireable* self = def->sel("self");
    Wireable* mux0 = def->addInstance(
      "mux0", mux, {{"width", Const::make(c, n)}});
    ...
    int s = compileCodeAndRun(
      topoOrder, g, muxM, "./gencode/", outFile, "test_mux8.cpp");
  ...
  SECTION("32 bit dshl test") {
    ...
    Type* dshlType = c->Record({{"A", c->Array(2, c->Array(n, c->BitIn()))},
                                {"out", c->Array(n, c->Bit())}});
    ...
    Wireable* self = def->sel("self");
    Wireable* dshl0 = def->addInstance(
      "dshl0", dshl, {{"width", Const::make(c, n)}});
    ...
    int s = compileCodeAndRun(
      topoOrder, g, dshlM, "./gencode/", outFile, "test_dshl32.cpp");
  ...
  SECTION("Multiply then shift 16 bit") {
    ...
    Type* dashrType = c->Record({{"A", c->Array(2, c->Array(n, c->BitIn()))},
                                 {"out", c->Array(n, c->Bit())}});
    ...
    Wireable* self = def->sel("self");
    Wireable* dashr0 = def->addInstance(
      "dashr0", dashr, {{"width", Const::make(c, n)}});
    auto mul0 = def->addInstance(
      "mul0", "coreir.mul", {{"width", Const::make(c, n)}});
    auto c0 = def->addInstance(
      "four",
      "coreir.const",
      {{"width", Const::make(c, n)}},
  ...
  SECTION("60 bit dashr test") {
    ...
    int s = compileCodeAndRun(
      topoOrder, g, dashrM, "./gencode/", outFile, "test_dashr60.cpp");
  ...
  SECTION("5 bit dlshr test") {
    ...
    Type* dlshrType = c->Record({{"A", c->Array(2, c->Array(n, c->BitIn()))},
                                 {"out", c->Array(n, c->Bit())}});
    ...
    Wireable* self = def->sel("self");
    Wireable* dlshr0 = def->addInstance(
      "dlshr0", dlshr, {{"width", Const::make(c, n)}});
    ...
    int s = compileCodeAndRun(
      topoOrder, g, dlshrM, "./gencode/", outFile, "test_dlshr5.cpp");
  ...
  SECTION("Unsigned 27 bit division") {
    ...
    Type* udivType = c->Record({{"A", c->Array(2, c->Array(n, c->BitIn()))},
                                {"out", c->Array(n, c->Bit())}});
    ...
    Wireable* self = def->sel("self");
    Wireable* udiv0 = def->addInstance(
      "udiv0", udiv, {{"width", Const::make(c, n)}});
    ...
    int s = compileCodeAndRun(
      topoOrder, g, udivM, "./gencode/", outFile, "test_udiv27.cpp");
  ...
  SECTION("Unsigned 13 bit remainder") {
    ...
    Type* uremType = c->Record({{"A", c->Array(2, c->Array(n, c->BitIn()))},
                                {"out", c->Array(n, c->Bit())}});
    ...
    Wireable* self = def->sel("self");
    Wireable* urem0 = def->addInstance(
      "urem0", urem, {{"width", Const::make(c, n)}});
    ...
    int s = compileCodeAndRun(
      topoOrder, g, uremM, "./gencode/", outFile, "test_urem13.cpp");
  ...
  SECTION("Signed 5 bit remainder") {
    ...
    Type* sremType = c->Record({{"A", c->Array(2, c->Array(n, c->BitIn()))},
                                {"out", c->Array(n, c->Bit())}});
    ...
    Wireable* self = def->sel("self");
    Wireable* srem0 = def->addInstance(
      "srem0", srem, {{"width", Const::make(c, n)}});
    ...
    int s = compileCodeAndRun(
      topoOrder, g, sremM, "./gencode/", outFile, "test_srem5.cpp");
  ...
  SECTION("Signed 5 bit division") {
    ...
    Type* sdivType = c->Record({{"A", c->Array(2, c->Array(n, c->BitIn()))},
                                {"out", c->Array(n, c->Bit())}});
    ...
    Wireable* self = def->sel("self");
    Wireable* sdiv0 = def->addInstance(
      "sdiv0", sdiv, {{"width", Const::make(c, n)}});
    ...
    int s = compileCodeAndRun(
      topoOrder, g, sdivM, "./gencode/", outFile, "test_sdiv5.cpp");
  ...
  SECTION("38 bit orr") {
    ...
    Wireable* self = def->sel("self");
    Wireable* orr0 = def->addInstance(
      "orr0", orr, {{"width", Const::make(c, n)}});
    ...
    int s = compileCodeAndRun(
      topoOrder, g, orrM, "./gencode/", outFile, "test_orr38.cpp");
  ...
  SECTION("59 bit andr") {
    ...
    Wireable* andr0 = def->addInstance(
      "andr0", andr, {{"width", Const::make(c, n)}});
    ...
    int s = compileCodeAndRun(
      topoOrder, g, andrM, "./gencode/", outFile, "test_andr59.cpp");
