...
Namespace* CoreIRLoadLibrary_rtlil(CoreIR::Context* c) {
  ...
  for (auto& name : rtlilBinops) {
    Params binopParams = {{"A_SIGNED", c->Bool()},
                          ...
                          {"Y_WIDTH", c->Int()}};
    TypeGen* logic_andTP =
      rtLib->newTypeGen(name, binopParams, [](Context* c, Values genargs) {
  ...
  TypeGen* muxTP =
    rtLib->newTypeGen("rtMux", muxParams, [](Context* c, Values genargs) {
  ...
  TypeGen* dffTP =
    rtLib->newTypeGen("dff", dffParams, [](Context* c, Values genargs) {
      uint width = genargs.at("WIDTH")->get<int>();
  ...
  TypeGen* adffTP =
    rtLib->newTypeGen("adff", adffParams, [](Context* c, Values genargs) {
      uint width = genargs.at("WIDTH")->get<int>();
  ...
  TypeGen* dlatchTP =
    rtLib->newTypeGen("dlatch", dlatchParams, [](Context* c, Values genargs) {
      uint width = genargs.at("WIDTH")->get<int>();
  ...
  Params dffsrParams = {{"WIDTH", c->Int()},
                        ...
                        {"CLK_POLARITY", c->Bool()}};
  TypeGen* dffsrTP =
    rtLib->newTypeGen("dffsr", dffsrParams, [](Context* c, Values genargs) {
      uint width = genargs.at("WIDTH")->get<int>();
  ...
  TypeGen* shiftxTP =
    rtLib->newTypeGen("shiftx", shiftxParams, [](Context* c, Values genargs) {
      uint a_width = genargs.at("A_WIDTH")->get<int>();
      uint b_width = genargs.at("B_WIDTH")->get<int>();
      uint y_width = genargs.at("Y_WIDTH")->get<int>();
  ...
  TypeGen* memTP =
    rtLib->newTypeGen("memory", memParams, [](Context* c, Values genargs) {
      uint width = genargs.at("WIDTH")->get<int>();
  ...
  TypeGen* padIOTP =
    rtLib->newTypeGen("padIO", padIOParams, [](Context* c, Values genargs) {
      uint width = genargs.at("WIDTH")->get<int>();
