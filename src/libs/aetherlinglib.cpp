...
Namespace* CoreIRLoadLibrary_aetherlinglib(Context* c) {
  ...
  // note that the input to the constant gets assigned the second input to the
  // two argument module WHILE THIS IS INTERESTING AND SHOULD WORK, doesn't
  // becuase it is a generator that produces a module and modules can't be
