          ...
          {"~in",
           []() {
             return std::make_unique<vAST::UnaryOp>(
               vAST::make_id("in"), vAST::UnOp::INVERT);
           }}},
         {"neg",
          {"-in",
           []() {
             return std::make_unique<vAST::UnaryOp>(
               vAST::make_id("in"), vAST::UnOp::MINUS);
           }}}}},
       {"unaryReduce",
        {{"andr",
          {"&in",
           []() {
             return std::make_unique<vAST::UnaryOp>(
               vAST::make_id("in"), vAST::UnOp::AND);
           }}},
         {"orr",
          {"|in",
           []() {
             return std::make_unique<vAST::UnaryOp>(
               vAST::make_id("in"), vAST::UnOp::OR);
           }}},
         {"xorr",
          {"^in",
           []() {
             return std::make_unique<vAST::UnaryOp>(
               vAST::make_id("in"), vAST::UnOp::XOR);
           }}}}},
       {"binary",
        {{"and",
          {"in0 & in1",
           []() {
             return std::make_unique<vAST::BinaryOp>(
               vAST::make_id("in0"), vAST::BinOp::AND, vAST::make_id("in1"));
           }}},
         {"or",
          {"in0 | in1",
           []() {
             return std::make_unique<vAST::BinaryOp>(
               vAST::make_id("in0"), vAST::BinOp::OR, vAST::make_id("in1"));
           }}},
         {"xor",
          {"in0 ^ in1",
           []() {
             return std::make_unique<vAST::BinaryOp>(
               vAST::make_id("in0"), vAST::BinOp::XOR, vAST::make_id("in1"));
           }}},
         {"shl",
          {"in0 << in1",
           []() {
             return std::make_unique<vAST::BinaryOp>(
               vAST::make_id("in0"), vAST::BinOp::LSHIFT, vAST::make_id("in1"));
           }}},
         {"lshr",
          {"in0 >> in1",
           []() {
             return std::make_unique<vAST::BinaryOp>(
               vAST::make_id("in0"), vAST::BinOp::RSHIFT, vAST::make_id("in1"));
           }}},
         {"ashr",
          {"$signed(in0) >>> in1",
           []() {
         ...
         {"add",
          {"in0 + in1",
           []() {
             return std::make_unique<vAST::BinaryOp>(
               vAST::make_id("in0"), vAST::BinOp::ADD, vAST::make_id("in1"));
           }}},
         {"sub",
          {"in0 - in1",
           []() {
             return std::make_unique<vAST::BinaryOp>(
               vAST::make_id("in0"), vAST::BinOp::SUB, vAST::make_id("in1"));
           }}},
         {"mul",
          {"in0 * in1",
           []() {
             return std::make_unique<vAST::BinaryOp>(
               vAST::make_id("in0"), vAST::BinOp::MUL, vAST::make_id("in1"));
           }}},
         {"udiv",
          {"in0 / in1",
           []() {
             return std::make_unique<vAST::BinaryOp>(
               vAST::make_id("in0"), vAST::BinOp::DIV, vAST::make_id("in1"));
           }}},
         {"sdiv",
       ...
       {"binaryReduce",
        {{"eq",
          {"in0 == in1",
           []() {
             return std::make_unique<vAST::BinaryOp>(
               vAST::make_id("in0"), vAST::BinOp::EQ, vAST::make_id("in1"));
           }}},
         {"neq",
          {"in0 != in1",
           []() {
             return std::make_unique<vAST::BinaryOp>(
               vAST::make_id("in0"), vAST::BinOp::NEQ, vAST::make_id("in1"));
           }}},
         {"slt",
          {"$signed(in0) < $signed(in1)",
           []() {
         ...
         {"ult",
          {"in0 < in1",
           []() {
             return std::make_unique<vAST::BinaryOp>(
               vAST::make_id("in0"), vAST::BinOp::LT, vAST::make_id("in1"));
           }}},
         {"ugt",
          {"in0 > in1",
           []() {
             return std::make_unique<vAST::BinaryOp>(
               vAST::make_id("in0"), vAST::BinOp::GT, vAST::make_id("in1"));
           }}},
         {"ule",
          {"in0 <= in1",
           []() {
             return std::make_unique<vAST::BinaryOp>(
               vAST::make_id("in0"), vAST::BinOp::LTE, vAST::make_id("in1"));
           }}},
         {"uge",
          {"in0 >= in1",
           []() {
             return std::make_unique<vAST::BinaryOp>(
               vAST::make_id("in0"), vAST::BinOp::GTE, vAST::make_id("in1"));
           }}}}},
       {"other",
        {
          {"mux",
           ...
           {"in[hi-1:lo]",
            []() {
              return std::make_unique<vAST::Slice>(
                vAST::make_id("in"),
                vAST::make_binop(
                  vAST::make_id("hi"), vAST::BinOp::SUB, vAST::make_num("1")),
                vAST::make_id("lo"));
            }}},
          {"concat",
           {"{in1,in0}",
